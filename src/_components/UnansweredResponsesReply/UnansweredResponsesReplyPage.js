...
export default function UnansweredResponsesComposePage({ GetUnansweredResponcesList, ReplyDetails }) {
    ...
    const OpenComposeReply = (e) => {
        ...
        document.getElementById("BCCReply").value = ""
    ...
    const SentMail = async () => {
        ...
        var CC = document.getElementById("CCReply").value;
        var BCC = document.getElementById("BCCReply").value;
